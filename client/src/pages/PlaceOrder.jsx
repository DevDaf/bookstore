...
export default function PlaceOrder() {
  ...
  const saveShippingAddress = () => {
    ...
    // Dispatch the action to save shipping address
    dispatch(
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/3 md:w-1/2 p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
              ...
              <PayPalScriptProvider options={{ clientId: "AWV_6qwicfwIjGXnyQvbC-mRrzz_L8PFGgCzxffdUYnSL7QH4-K5EN2FxSaaGc7BGTEInsc2iGX6W66q" }}>
            <PayPalButtons
